...
namespace WebMyMoney.Default.Endpoints
{
    ...
    using MyRepository = Repositories.CadFaturaCartaoCreditoRepository;
    using MyRow = Entities.CadFaturaCartaoCreditoRow;

    [RoutePrefix("Services/Default/CadFaturaCartaoCredito"), Route("{action}")]
    [ConnectionKey(typeof(MyRow)), ServiceAuthorize(typeof(MyRow))]
    public class CadFaturaCartaoCreditoController : ServiceEndpoint
    {

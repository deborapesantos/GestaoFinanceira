...
namespace WebMyMoney.Administration.Entities
{
    ...
    [ConnectionKey("Default"), Module("Administration"), TableName("[dbo].[Users]")]
    ...
    public sealed class UserRow : LoggingRow, IIdRow, INameRow
    {
        ...
        [DisplayName("Usuário Vinculado"), Insertable(true), Updatable(true)]
        public Int32? UsuarioId
        {
            get { return Fields.UsuarioId[this]; }
            set { Fields.UsuarioId[this] = value; }
        }

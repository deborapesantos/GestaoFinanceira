...
namespace WebMyMoney.Administration.Repositories
{
    using Serenity;
    using Serenity.Data;
    ...
    public partial class UserRepository
    {
        ...
        private class MySaveHandler : SaveRequestHandler<MyRow>
        {
            ...
            protected override void ValidateRequest()
            {
                ...
                if (IsUpdate)
                {
                    ...
                    if (Row.Username != Old.Username)
                        Row.Username = ValidateUsername(this.Connection, this.Row.Username, null);
            ...
            protected override void SetInternalFields()
            {
                ...
                if (IsCreate)
                {
                    var ultimo = this.Connection.List<MyRow>().ToList().OrderBy(x => x.UserId).LastOrDefault();
                    Row.UserId = ultimo.UserId + 1;
                }

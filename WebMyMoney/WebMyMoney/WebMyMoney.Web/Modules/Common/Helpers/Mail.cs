...
namespace WebMyMoney.Common
{
    ...
    public abstract class Mail
    {
        ...
        /// </summary>
        /// <param name="parametroWebConfig">Se informar "false", os parametros de configuração deverão estar preenchidos:
        ...
        public void AdicionarDestinatario(TipoDestinatario tipoDestinatario, string nome, string email)
        {
            ...
            {
                throw new Exception($"Email {email} não é válido.");
            }
        ...
        /// </summary>
        /// <param name="pParametrosBody">Dicionario key,value, onde key é o nome da variavel do modelo html, e value o valor a ser atribuido a ela</param>
        /// <param name="pCaminhoModelo">Diretorio do modelo HTML de email padrão - Caminho Fisico da Aplicacao+PastaModelos do webconfig+nomeModelo.html</param>
        public static string GetBodyFromModelo(Dictionary<string, string> pParametros, string pCaminhoModelo)
        {
            ...
            try
            {
                if (!File.Exists(pCaminhoModelo))
                    throw new Exception($"Arquivo html de modelo do email não encontrado ({pCaminhoModelo}).");
        ...
        /// <summary>
        /// Retorna se um email é válido.get 
        /// </summary>
        /// <param name="emailaddress">Email para teste</param>
        /// <returns>Retorna true caso a conversão seja bem-sucedida.</returns>
        /// https://stackoverflow.com/questions/1365407/c-sharp-code-to-validate-email-address

    ...
    declare namespace Db {
        ...
        namespace Default {
            ...
            namespace CadGrupoFamiliar {
                ...
                export const DataCriacao: string;
                export const IsGrupoPessoal: string;
            ...
            namespace CadUsuario {
                ...
                export const DataCriacao: string;
                export const Email: string;
                export const GrupoPessoalId: string;
            ...
            namespace PermissaoUserVisualizarGrupo {
                export const CadGrupoFamiliarId: string;
                export const CadUsuarioId: string;
                export const NomeGrupo: string;
                export const PermissaoVisualizar: string;
            }
